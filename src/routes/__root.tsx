...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Kiki Glam — Luxury Bridal & Editorial Makeup Artistry, Lagos" },
      { property: "og:description", content: "Kiki Glam is a Lagos-based luxury makeup artistry brand crafting flawless, camera-ready bridal, event and editorial looks — locally and on destination bookings." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Kiki Glam — Luxury Bridal & Editorial Makeup Artistry, Lagos" },
      { name: "twitter:description", content: "Kiki Glam is a Lagos-based luxury makeup artistry brand crafting flawless, camera-ready bridal, event and editorial looks — locally and on destination bookings." },
